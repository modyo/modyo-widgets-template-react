...
export default {
  ...
  async created() {
    ...
    this.allPosts = allPosts.entries.map((post) => ({
      id: post.meta.uuid,
      title: post.meta.name,
      updatedAt: new Date(post.meta.updated_at),
      publishedAt: new Date(post.meta.published_at),
      description: post.fields.Details,
      excerpt: post.fields.Excerpt,
      image: post.fields.Featured.url,
